...
namespace Cosmosim
{
    public class ShipInputDesktop : MonoBehaviour, IInputShipMovement, IInputShipWeapons
    {
        ...
        public float CurrentInputMove { get; private set; }
        ...
        [field: Header("Ship atack Values")] public bool CurrentInputAttack { get; private set; }
